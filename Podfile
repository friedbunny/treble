...
target 'treble' do
    ...
    pod 'Mapbox-iOS-SDK-symbols', :podspec => 'https://raw.githubusercontent.com/mapbox/mapbox-gl-native/ios-v4.3.0-alpha.1/platform/ios/Mapbox-iOS-SDK-symbols.podspec'
